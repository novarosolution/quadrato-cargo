  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6" noValidate>
      ...
      <motion.button
        ...
        className="btn-primary inline-flex w-full items-center justify-center rounded-2xl border border-teal/70 bg-teal px-6 py-3.5 text-sm font-semibold text-slate-950 shadow-lg shadow-teal/25 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
      >
