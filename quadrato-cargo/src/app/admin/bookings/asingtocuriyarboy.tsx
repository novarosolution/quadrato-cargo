  ...
  return (
    <div className="rounded-2xl border border-border-strong bg-surface-elevated/50 p-5">
      ...
      <p className="mt-1 text-xs text-muted-soft">
        Pick who collects / delivers this shipment. Couriers sign in on the site
        and open <span className="font-mono text-[11px]">/courier</span> for
        their jobs. Inactive couriers are shown but cannot be assigned.
      </p>
